...
<nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow ">
	<a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3 my-2 text-center" href="index.php"> <big>Şahin  Kütüphanesi</big> </a>
	<nav class="nav ">
	...
	<ul class="navbar-nav ">
		<li class="nav-item text-nowrap">
			<a class="btn btn-dark text-info " href="cikis.php">Çıkış Yap </a>
		</li>
	</ul>
</nav>