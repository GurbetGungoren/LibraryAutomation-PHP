...
<body>
	<nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
		<a class="navbar-brand col-md-3 col-lg-3 mr-0 px-3 my-2 text-center " href="#"> <big>Güngören  Kütüphanesi </big> </a>
			...
			<div class="row ">
				...
				<div class="col-10">
					...
					<div class="row jumbotron">
						<div class="col-4">	</div>
						<div class="col-8 " >
							<h2 class=" mb-4 ml-5 px-5 text-info "> <strong> Kitap Arama </strong></h2>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-9 ml-1	">
						...
						<table class="table table-hover ">
							<thead>
								<tr class="text-warning" style="font-size: 120%">
